...
function normalizeMember(input) {
  ...
  return {
    ...
    skill_forehand: safeNumber(input.skill_forehand ?? 5, 1, 10, 5),
    skill_backhand: safeNumber(input.skill_backhand ?? 5, 1, 10, 5),
    skill_volley: safeNumber(input.skill_volley ?? 5, 1, 10, 5),
    skill_slice: safeNumber(input.skill_slice ?? 5, 1, 10, 5),
    skill_dropshot: safeNumber(input.skill_dropshot ?? 5, 1, 10, 5),
    skill_lob: safeNumber(input.skill_lob ?? 5, 1, 10, 5),
